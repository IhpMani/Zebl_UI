...
@Component({
  selector: 'app-patient-list-legacy',
  templateUrl: './patient-list-legacy.component.html',
  styleUrls: ['./patient-list-legacy.component.css']
})
export class PatientListLegacyComponent implements OnInit, OnDestroy {
  ...
  columns: Array<{
    ...
    { key: 'patPaymentMatchingKey', label: 'Payment Matching Key', visible: false, filterValue: '' },
